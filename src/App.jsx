...
export default function MonacoDetailingSite() {
  ...
  function ServiceCard({ s }) {
    return (
      <div style={{ background: ui.panel, border: `1px solid ${ui.border}`, borderRadius: 16, padding: 16, boxShadow: '0 4px 20px rgba(0,0,0,.25)' }}>
  ...
  return (
    <div style={{ minHeight:'100vh', background: ui.bg, color: ui.text }}>
      {/* Header */}
      <header style={{ position:'sticky', top:0, backdropFilter:'blur(6px)', background:'rgba(10,10,10,.85)', borderBottom:`1px solid ${ui.border}`, zIndex:50 }}>
          ...
          <div style={{ display:'grid', gap:16 }}>
            ...
            <form onSubmit={(e) => { e.preventDefault(); wamsg("Hola, completé el formulario del sitio y quiero reservar un servicio."); }}
              ...
              <div style={{ display:'grid', gap:12 }}>
                ...
                <select defaultValue="" required style={{ background: ui.bg, border:`1px solid ${ui.border}`, borderRadius:12, padding:'12px 14px', color: ui.text }}>
