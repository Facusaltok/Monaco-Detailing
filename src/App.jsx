...
export default function MonacoDetailingSite() {
  ...
  const services = {
    autos: [
      { name: "Interior (Hatch / Sedan)", desc: "Aspirado profundo, descontaminación del habitáculo y reacondicionamiento de plásticos.", price: 150000, time: "2–3 días" },
      ...
      { name: "Paquete Completo (Hatch / Sedan)", desc: "Abrillantado + Interior + Motor a Vapor.", price: 300000, time: "2–3 días" }
    ],
    suv: [
      { name: "Interior (SUV / Pick-Up)", desc: "Aspirado profundo, descontaminación del habitáculo y reacondicionamiento de plásticos.", price: 200000, time: "2–3 días" },
      ...
      { name: "Paquete Completo SUV / Pick-Up", desc: "Abrillantado + Interior + Motor a Vapor.", price: 400000, time: "2–3 días" }
    ],
    motos: [
  ...
  const tratamientos = [
    { grupo: "Autos (Hatch / Sedan)", items: [
      ...
      { name: "Cerámico", detalle: "Duración 1 año", price: 350000 },
      { name: "Cerámico c/Grafeno", detalle: "Duración 2 años", price: 450000 }
    ]},
  ...
  const ui = {
    ...
    text: '#e5e7eb',
    mut: '#94a3b8',
    green: '#0a8d4b' // verde más oscuro como tu logo
  };
  ...
  function Price({ value }) {
    return <span style={{ color: ui.green, fontWeight: 700 }}>
  ...
  return (
    <div style={{ minHeight:'100vh', background: ui.bg, color: ui.text }}>
          ...
          <div style={{ display:'grid', gap:24, gridTemplateColumns:'1fr' }}>
            <div>
              <h1 style={{ fontSize:36, lineHeight:1.2, fontWeight:800 }}>
                Detailing premium para un <span style={{ color: ui.green }}>acabado de showroom</span>
              </h1>
              ...
              <div style={{ display:'flex', gap:12, marginTop:16, flexWrap:'wrap' }}>
                <button onClick={() => wamsg("Hola, quiero un turno para el paquete completo.")}
              ...
              <p style={{ color: ui.mut, fontSize:12, marginTop:10 }}>
                * Motor en el día. Resto de servicios: 2–3 días.
              </p>
            </div>
          </div>
        </div>
                ...
                {t.items.map((it, i) => (
                  <div key={i} style={{ display:'flex', justifyContent:'space-between', gap:12, marginTop:12 }}>
                    ...
                    <div style={{ textAlign:'right' }}>
                      ...
                      <button onClick={() => wamsg(`Hola, me interesa el tratamiento ${it.name} (${t.grupo}) por $${it.price.toLocaleString('es-AR')}.`)}
      ...
      {/* Mapa (reemplaza galería) */}
      <section id="mapa">
        <div style={{ ...wrap, padding:'40px 16px' }}>
          <h2 style={{ fontSize:24, fontWeight:700 }}>Encontranos</h2>
          <p style={{ color: ui.mut }}>Carlos Francisco Melo 3685, Vicente López, Buenos Aires</p>
          <div style={{ marginTop:12, border:`1px solid ${ui.border}`, borderRadius:16, overflow:'hidden' }}>
            <iframe
              title="Ubicación"
